...
public abstract class Console implements IServiceSetter {
	...
	protected abstract String prefix(INetDisk disk, Object... target);

	protected abstract boolean exit(String cmd);

	public void monitor(INetDisk disk, Object... target)
			throws IOException {
		InputStreamReader input = new InputStreamReader(System.in);
		BufferedReader read = new BufferedReader(input);
		String prefix = prefix(disk, target);
	...
	protected void printMan(INetDisk disk, Object[] target,
